...
-- 1) create the type at the top of the file
...
-- create the relationship at the bottom
...
-- Update description for GM Hummer using REPLACE (uses PK via subquery)
...
-- Add '/vehicles' to inv_image and inv_thumbnail for all inventory rows
UPDATE public.inventory
